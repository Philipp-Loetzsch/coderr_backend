...
# from django_filters.rest_framework import DjangoFilterBackend
# from rest_framework.pagination import PageNumberPagination
# from django.db.models import Min, Max, Value, DecimalField # Ensure Value and DecimalField are imported
# from django.db.models.functions import Coalesce
...
# )
# from .permissions import IsBusinessUser, IsOfferOwner
# # Import only the simplified OfferFilter
# from .filters import OfferFilter
# # CustomOfferOrderingFilter is no longer imported or used
...
#     """
#     Lists all offers (GET, with filtering/search/ordering) or creates a new offer (POST).
#     Uses standard DRF OrderingFilter. Frontend must use annotation names for price sorting.
#     """
#     serializer_class = OfferListSerializer
