...
class OfferListCreateView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        # Define a default high value for min_price when sorting ascending (None would be first)
        # Define a default low value for max_price when sorting descending (None would be first)
        # For simplicity, Coalesce to 0 or a very large/small number if specific None handling is needed.
        # Here, we'll coalesce to 0.00 for price if no details exist.
